...
tf.app.flags.DEFINE_integer('max_image_large_side', 1500,
...
# def trans_image(im, index):
#
#     im1 = im
#     im2 = np.zeros([im1.shape[0],im1.shape[1],im1.shape[2]],im1.dtype)
#     if index == 0:
#         # print('000000000')
#         img = cv2.addWeighted(im1,1.5,im2,2,0)
#
#     elif index == 1:
#         # print('1111111111111')
#         img = cv2.addWeighted(im1,1,im2,2,40)
#
#     # elif index == 2:
#     #     b, g, r = cv2.split(im)
#     #     img = r
...
def crop_area(im, polys, tags, crop_background=False, max_tries=50):
    ...
    # w_axis = np.where(w_arraymax_image_large_side == 0)[0]
    ...
    while True:
        ...
        for i in index:
            try:
                ...
                im = cv2.imread(im_fn)
                im = augumentor(im)
                # cv2.imwrite('./tmp/' + str(inx) + '.jpg', im)
                # im = np.rot90(im, 3)
                # print im_fn
                h, w, _ = im.shape
